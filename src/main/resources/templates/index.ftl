                            ...
                            <div class="feed-item-inner">
                                <div class="avatar">
                                    ...
                                    <a title="${vo.user.name}" data-tip="p$t$zhao-yong-feng" class="zm-item-link-avatar" target="_blank" href="/user/${vo.user.id}">
                                        <img src="${vo.user.headUrl!'https://images.nowcoder.com/images/20180121/9312266_1516523012792_7C2C60506876716CCF0E706DB13D4511?x-oss-process=image/resize,m_mfit,h_200,w_200'}" class="zm-item-img-avatar"></a>   <#--头像-->
                                </div>
                                <div class="feed-main">
                                    <div class="feed-content" data-za-module="PostItem">
                                        ...
                                        <h2 class="feed-title">
                                            <a target="_blank" class="post-link" href="question/${vo.question.id}">${vo.question.title}</a></h2>     <!--问题标题-->
